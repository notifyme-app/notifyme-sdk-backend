...
public class JdbcN2StepDataServiceImpl implements N2StepDataService {

    private static final Logger logger = LoggerFactory.getLogger(JdbcN2StepDataServiceImpl.class);

    private final String dbType;
    private final NamedParameterJdbcTemplate jt;
    private final SimpleJdbcInsert traceKeyInsert;

    public JdbcN2StepDataServiceImpl(String dbType, DataSource dataSource) {
        this.dbType = dbType;
